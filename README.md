...
![alt text](image.png) (admittedly the parts that are scribbled out in red are because i forgot to run the bot those days or drew an X over the month for no reason)
